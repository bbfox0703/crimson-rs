...
//!
//! Resolves save-side `GlobalGameEventInfoKey (u16-widened-u32)` to
//! template names (`"Drought_Varnian"`, `"Flood_Demenissian"`, …).
//! Name-only, 103 rows in 1.07.

crate::impl_name_only_bridge! {
    handle = CrimsonGlobalGameEventInfoHandle,
    parser = crate::global_game_event_info::parse_global_game_event_info_lossy,
    entry_ty = crate::global_game_event_info::GlobalGameEventInfoEntry,
    load_from_file = crimson_global_game_event_info_load_from_file,
    load_from_bytes = crimson_global_game_event_info_load_from_bytes,
    free = crimson_global_game_event_info_free,
    entry_count = crimson_global_game_event_info_entry_count,
    lookup_string_key = crimson_global_game_event_info_lookup_string_key,
    get_entry = crimson_global_game_event_info_get_entry,
    key_param = global_game_event_key,
}
